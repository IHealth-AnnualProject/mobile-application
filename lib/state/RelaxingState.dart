...
class RelaxingState extends State<RelaxingView> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    curvedAnimation = new CustomCurvedAnimation.withoutCurve(begin: 0.2,end: 1,duration: Duration(seconds: 4), vsync: this );
    curvedAnimation.addListenerOnAnimation((status)  {
